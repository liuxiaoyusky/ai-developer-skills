...
### 详细指南 (docs/)
- ✅ `docs/cost-optimization.md` - 成本优化详细指南（含真实数据分析）
- ✅ `docs/security-hardening.md` - 安全加固详细指南
- ✅ `docs/troubleshooting.md` - 故障排除详细指南（含生产调试框架）
...
- ✅ 4 个核心调试理论（错误信息即真理、工具成功≠用户成功等）
- ✅ 生产环境验证流程（Step-by-step bash 命令）
- ✅ 真实案例研究（失败 vs 正确做法）
- ✅ 5 条黄金调试法则
- ✅ Cache-busting 验证方法
- ✅ 防止验证差距的最佳实践
